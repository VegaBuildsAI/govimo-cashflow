# AGENTS.md — Govimo Cashflow · brief de construcción (Codex Fable 5)

Brief operativo para Codex con **Codex Fable 5**. Léelo una vez y construye. La verdad del proyecto vive en los 3 `.docx` de esta carpeta — ábrelos cuando los necesites; **no copies su contenido aquí**.
...
- Mantén `AGENTS.md`, `PLAN.md` y notas **cortos**.
